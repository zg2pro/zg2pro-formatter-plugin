...
public enum Settings {
	...
	PUBLIC_URL_BO("sigis.web.bo.domain", "http://localhost:8080/sigis-web-bo/"),
	PUBLIC_URL_FO("sigis.web.fo.domain", "http://localhost:8080/sigis-web-fo/"),
	...
	SIGIS_WEBSITE_URL("sigis.website.url", "http://localhost:8080/sigis-web-fo/"),
	...
	WIKI_BO_URL("sigis.wiki.bo.url", "http://localhost/man-bo"),
	WIKI_FO_URL("sigis.wiki.fo.url", "http://localhost/man-fo"),
