...
[![Build](https://travis-ci.com/zg2pro/zg2pro-formatter-plugin.svg?branch=master)](https://travis-ci.com/zg2pro/zg2pro-formatter-plugin)
...
Another option is `<runGroovyFormatterInAutonomousThread>true</runGroovyFormatterInAutonomousThread>` : As the groovy formatter can take up to 30 seconds to get started
you might want to run it in parrallel with your other formatters. Especially if your code takes more than 1 minute to be wholly formatted. The command argument
equivalent is `-Dzg2pro.format.run.groovy.formatter.in.thread=true`
